...
export const fixedPriceAbiProd = [
  ...
  {
    inputs: [],
    name: "Escrow__AuthorizationExpired",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__ContractIdAlreadyExists",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__CreateDisputeNotAllowed",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__InvalidFeeConfig",
    type: "error",
  },
  {
    inputs: [],
    name: "Escrow__InvalidRange",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__InvalidStatusForApprove",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__InvalidStatusProvided",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__InvalidStatusToWithdraw",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__NoReturnRequested",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__NotSupportedPaymentToken",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__PaymentTokenMismatch",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__UnauthorizedReceiver",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__UnauthorizedToApproveReturn",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "Escrow__ZeroDepositAmount",
    type: "error",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IEscrowAdminManager",
        name: "",
        type: "address",
      },
    ],
    ...
    inputs: [
      {
        components: [
          ...
          {
            internalType: "enum Enums.Status",
            name: "status",
            type: "uint8",
          },
          {
